...
const BookOpenCheck = createLucideIcon("book-open-check", __iconNode$S);
const __iconNode$R = [
...
const HeartPulse = createLucideIcon("heart-pulse", __iconNode$x);
const __iconNode$w = [
...
const Hotel = createLucideIcon("hotel", __iconNode$w);
