    ...
    >
      <div className="container-mt">
        ...
        >
          ...
          <motion.div
            variants={fadeUp}
            className="rounded-3xl border border-destructive/30 bg-card p-8"
          >
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                ...
                <h3 className="text-lg font-bold text-foreground">Sin automatización</h3>
              </div>
            </div>
          ...
          <motion.div
            variants={fadeUp}
            className="rounded-3xl border border-primary/40 bg-card p-8 relative"
          >
            {/* Acento de fondo */}
            <div
              aria-hidden
              className="absolute inset-0 rounded-3xl -z-10 opacity-[0.06]"
              style={{
                backgroundImage:
            ...
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                ...
                <h3 className="text-lg font-bold text-foreground">Automatización activa</h3>
              </div>
            </div>
            <ul className="space-y-3">
              {conMetatok.map((item) => (
        ...
        >
          ...
          >
            Quiero descubrir cuánto estoy perdiendo
